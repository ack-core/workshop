...
namespace fg {
    namespace opengl {
        class OpenGLES3Win32Platform;
        class PlatformObject : public uncopyable{
        public:
            PlatformObject(OpenGLES3Win32Platform *owner) : _owner(owner) {}
        ...
        protected:
            PlatformVertexBuffer(OpenGLES3Win32Platform *owner, platform::VertexType type, unsigned vcount, GLenum usage);
        ...
        protected:
            PlatformIndexedVertexBuffer(OpenGLES3Win32Platform *owner, platform::VertexType type, unsigned vcount, unsigned icount, GLenum usage);
        ...
        protected:
            PlatformInstanceData(OpenGLES3Win32Platform *owner, platform::InstanceDataType type, unsigned instanceCount);
        ...
        protected:
            PlatformRenderState(OpenGLES3Win32Platform *owner, platform::CullMode cullMode, platform::BlendMode blendMode, bool depthEnabled, platform::DepthFunc depthCmpFunc, bool depthWriteEnabled);
        ...
        protected:
            PlatformSampler(OpenGLES3Win32Platform *owner, platform::TextureFilter filter, platform::TextureAddressMode addrMode, float minLod, float bias);
            GLuint _self = 0;
        };
        ...
        public:
            PlatformShader(OpenGLES3Win32Platform *owner, const byteinput &binary, const diag::LogInterface &log);
        ...
        protected:
            PlatformShaderConstantBuffer(OpenGLES3Win32Platform *owner, unsigned index, unsigned length);
        ...
        protected:
            PlatformTexture2D();
            PlatformTexture2D(OpenGLES3Win32Platform *owner, platform::TextureFormat fmt, unsigned originWidth, unsigned originHeight, unsigned mipCount);
            PlatformTexture2D(OpenGLES3Win32Platform *owner, unsigned char *const *imgMipsBinaryData, unsigned originWidth, unsigned originHeight, unsigned mipCount, platform::TextureFormat fmt);
        ...
        protected:
            PlatformTextureCube();
            PlatformTextureCube(OpenGLES3Win32Platform *owner, unsigned char **imgMipsBinaryData[6], unsigned originSize, unsigned mipCount, platform::TextureFormat format);
        ...
        protected:
            ...
            PlatformRenderTarget(OpenGLES3Win32Platform *owner, unsigned colorTargetCount, unsigned originWidth, unsigned originHeight, platform::RenderTargetType type, platform::TextureFormat fmt);
        ...
        protected:
            ...
            PlatformCubeRenderTarget(OpenGLES3Win32Platform *owner, unsigned originSize, platform::RenderTargetType type, platform::TextureFormat fmt);
        ...
        struct OpenGLES3Win32PlatformInitParams : public platform::InitParams {
            float appWidth;
            float appHeight;
            HWND  hWindow;
        };

        class OpenGLES3Win32Platform : public platform::EnginePlatformInterface, public uncopyable {
        public:
            OpenGLES3Win32Platform(const diag::LogInterface &log);
