...
namespace fg {
    namespace opengl {
        ...
        PlatformVertexBuffer::PlatformVertexBuffer(OpenGLES3X11Platform *owner,  platform::VertexType type, unsigned vcount, GLenum usage) : PlatformObject(owner) {
            _type = type;
            _usage = usage;
        ...
        PlatformIndexedVertexBuffer::PlatformIndexedVertexBuffer(OpenGLES3X11Platform *owner, platform::VertexType type, unsigned vcount, unsigned icount, GLenum usage) : PlatformObject(owner) {
            _type = type;
            _usage = usage;
        ...
        PlatformInstanceData::PlatformInstanceData(OpenGLES3X11Platform *owner, platform::InstanceDataType type, unsigned instanceCount) : PlatformObject(owner) {
        ...
        PlatformRenderState::PlatformRenderState(OpenGLES3X11Platform *owner, platform::CullMode cullMode, platform::BlendMode blendMode, bool depthEnabled, platform::DepthFunc depthCmpFunc, bool depthWriteEnabled) : PlatformObject(owner) {
            _cullMode = cullMode;
        ...
        PlatformSampler::PlatformSampler(OpenGLES3X11Platform *owner, platform::TextureFilter filter, platform::TextureAddressMode addrMode, float minLod, float bias) : PlatformObject(owner) {
        ...
        PlatformShader::PlatformShader(OpenGLES3X11Platform *owner, const byteinput &binary, const diag::LogInterface &log) : PlatformObject(owner) {
        ...
        PlatformShaderConstantBuffer::PlatformShaderConstantBuffer(OpenGLES3X11Platform *owner, unsigned index, unsigned length) : PlatformObject(owner) {
            _index = index;
            _length = length;
            glGenBuffers(1, &_ubo);
        }
        ...
        PlatformTexture2D::PlatformTexture2D(OpenGLES3X11Platform *owner, platform::TextureFormat fmt, unsigned originWidth, unsigned originHeight, unsigned mipCount) : PlatformObject(owner) {
        ...
        PlatformTexture2D::PlatformTexture2D(OpenGLES3X11Platform *owner, unsigned char *const *imgMipsBinaryData, unsigned originWidth, unsigned originHeight, unsigned mipCount, platform::TextureFormat fmt) : PlatformObject(owner) {
            _owner->resetLastTextures();
            _format = fmt;
            _width = originWidth;
            _height = originHeight;
        ...
        PlatformTextureCube::PlatformTextureCube(OpenGLES3X11Platform *owner, unsigned char **imgMipsBinaryData[6], unsigned originSize, unsigned mipCount, platform::TextureFormat format) : PlatformObject(owner) {
            _owner->resetLastTextures();
            _format = format;
        ...
        PlatformRenderTarget::PlatformRenderTarget(OpenGLES3X11Platform *owner, unsigned colorTargetCount, unsigned originWidth, unsigned originHeight, platform::RenderTargetType type, platform::TextureFormat fmt) : PlatformObject(owner) {
            _owner->resetLastTextures();
        ...
        PlatformCubeRenderTarget::PlatformCubeRenderTarget(OpenGLES3X11Platform *owner, unsigned originSize, platform::RenderTargetType type, platform::TextureFormat fmt) : PlatformObject(owner) {
            _owner->resetLastTextures();
            _type = type;
            _depthTexture._format = platform::TextureFormat::UNKNOWN;
        ...
        OpenGLES3X11Platform::OpenGLES3X11Platform(const diag::LogInterface &log) : _log(log) {

        }

        bool OpenGLES3X11Platform::init(const platform::InitParams &initParams) {
            EGLint lastError = EGL_SUCCESS;
            OpenGLES3X11PlatformInitParams &params = (OpenGLES3X11PlatformInitParams &)initParams;
        ...
        void OpenGLES3X11Platform::destroy() {
            eglMakeCurrent(_eglDisplay, EGL_NO_SURFACE, EGL_NO_SURFACE, EGL_NO_CONTEXT);
            eglTerminate(_eglDisplay);
        ...
        float OpenGLES3X11Platform::getScreenWidth() const {
            return _nativeWidth;
        }

        float OpenGLES3X11Platform::getScreenHeight() const {
            return _nativeHeight;
        }

        float OpenGLES3X11Platform::getCurrentRTWidth() const {
            return float(_curRTWidth);
        }

        float OpenGLES3X11Platform::getCurrentRTHeight() const {
            return float(_curRTHeight);
        }

        float OpenGLES3X11Platform::getTextureWidth(platform::TextureSlot slot) const {
            return _lastTextureWidth[unsigned(slot)];
        }

        float OpenGLES3X11Platform::getTextureHeight(platform::TextureSlot slot) const {
            return _lastTextureHeight[unsigned(slot)];
        }

        unsigned OpenGLES3X11Platform::getMemoryUsing() const {
            return 0;
        }

        unsigned OpenGLES3X11Platform::getMemoryLimit() const {
            return 0;
        }

        unsigned long long OpenGLES3X11Platform::getTimeMs() const {
            return std::chrono::duration_cast<std::chrono::milliseconds>(std::chrono::system_clock::now().time_since_epoch()).count();
        }

        void OpenGLES3X11Platform::updateOrientation() {
        
        }

        void OpenGLES3X11Platform::resize(float width, float height) {
            glViewport(0, 0, GLsizei(width), GLsizei(height));
        }

        const math::m3x3 &OpenGLES3X11Platform::getInputTransform() const {
            static math::m3x3 _idmat;
            return _idmat;
        }

        void OpenGLES3X11Platform::fsFormFilesList(const char *path, std::string &out) {
            struct fn {
        ...
        bool OpenGLES3X11Platform::fsLoadFile(const char *path, void **oBinaryDataPtr, unsigned int *oSize) {
        ...
        bool OpenGLES3X11Platform::fsSaveFile(const char *path, void *iBinaryDataPtr, unsigned iSize) {
        ...
        void OpenGLES3X11Platform::sndSetGlobalVolume(float volume) {
        
        }

        platform::SoundEmitterInterface *OpenGLES3X11Platform::sndCreateEmitter(unsigned sampleRate, unsigned channels) {
            return nullptr;
        }

        platform::VertexBufferInterface *OpenGLES3X11Platform::rdCreateVertexBuffer(platform::VertexType vtype, unsigned vcount, bool isDynamic, const void *data) {
        ...
        platform::IndexedVertexBufferInterface *OpenGLES3X11Platform::rdCreateIndexedVertexBuffer(platform::VertexType vtype, unsigned vcount, unsigned ushortIndexCount, bool isDynamic, const void *vdata, const void *idata) {
        ...
        platform::InstanceDataInterface *OpenGLES3X11Platform::rdCreateInstanceData(platform::InstanceDataType type, unsigned instanceCount) {
        ...
        platform::ShaderInterface *OpenGLES3X11Platform::rdCreateShader(const byteinput &binary) {
        ...
        platform::RenderStateInterface *OpenGLES3X11Platform::rdCreateRenderState(platform::CullMode cullMode, platform::BlendMode blendMode, bool depthEnabled, platform::DepthFunc depthCmpFunc, bool depthWriteEnabled) {
        ...
        platform::SamplerInterface *OpenGLES3X11Platform::rdCreateSampler(platform::TextureFilter filter, platform::TextureAddressMode addrMode, float minLod, float bias) {
        ...
        platform::ShaderConstantBufferInterface *OpenGLES3X11Platform::rdCreateShaderConstantBuffer(platform::ShaderConstBufferUsing appoint, unsigned byteWidth) {
        ...
        platform::Texture2DInterface *OpenGLES3X11Platform::rdCreateTexture2D(unsigned char *const *imgMipsBinaryData, unsigned originWidth, unsigned originHeight, unsigned mipCount, platform::TextureFormat fmt) {
        ...
        platform::Texture2DInterface *OpenGLES3X11Platform::rdCreateTexture2D(platform::TextureFormat format, unsigned originWidth, unsigned originHeight, unsigned mipCount) {
        ...
        platform::TextureCubeInterface *OpenGLES3X11Platform::rdCreateTextureCube(unsigned char **imgMipsBinaryData[6], unsigned originSize, unsigned mipCount, platform::TextureFormat fmt) {
        ...
        platform::RenderTargetInterface *OpenGLES3X11Platform::rdCreateRenderTarget(unsigned colorTargetCount, unsigned originWidth, unsigned originHeight, platform::RenderTargetType type, platform::TextureFormat fmt) {
        ...
        platform::CubeRenderTargetInterface *OpenGLES3X11Platform::rdCreateCubeRenderTarget(unsigned originSize, platform::RenderTargetType type, platform::TextureFormat fmt) {
        ...
        platform::RenderTargetInterface *OpenGLES3X11Platform::rdGetDefaultRenderTarget() {
            return &_defaultRenderTarget;
        }

        void OpenGLES3X11Platform::rdClearCurrentRenderTarget(const color &c, float depth) {
            glClearDepthf(depth);
            glClearColor(std::pow(c.r, 1.0f / 2.2f), std::pow(c.g, 1.0f / 2.2f), std::pow(c.b, 1.0f / 2.2f), std::pow(c.a, 1.0f / 2.2f));
            glClear(GL_COLOR_BUFFER_BIT | GL_DEPTH_BUFFER_BIT);
        }

        void OpenGLES3X11Platform::rdSetRenderTarget(const platform::RenderTargetInterface *rt) {
        ...
        void OpenGLES3X11Platform::rdSetCubeRenderTarget(const platform::CubeRenderTargetInterface *rt, unsigned faceIndex) {
        ...
        void OpenGLES3X11Platform::rdSetShader(const platform::ShaderInterface *vshader) {
        ...
        void OpenGLES3X11Platform::rdSetRenderState(const platform::RenderStateInterface *params) {
        ...
        void OpenGLES3X11Platform::rdSetSampler(platform::TextureSlot slot, const platform::SamplerInterface *sampler) {
        ...
        void OpenGLES3X11Platform::rdSetShaderConstBuffer(const platform::ShaderConstantBufferInterface *cbuffer) {
        ...
        void OpenGLES3X11Platform::rdSetTexture2D(platform::TextureSlot slot, const platform::Texture2DInterface *texture) {
        ...
        void OpenGLES3X11Platform::rdSetTextureCube(platform::TextureSlot slot, const platform::TextureCubeInterface *texture) {
        ...
        void OpenGLES3X11Platform::rdSetScissorRect(const math::p2d &topLeft, const math::p2d &bottomRight) {
            glScissor(int(topLeft.x), int(topLeft.y), int(bottomRight.x - topLeft.x), int(bottomRight.y - topLeft.y));
        }
        
        void OpenGLES3X11Platform::rdDrawGeometry(const platform::VertexBufferInterface *vbuffer, const platform::InstanceDataInterface *instanceData, platform::PrimitiveTopology topology, unsigned vertexCount, unsigned instanceCount) {
        ...
        void OpenGLES3X11Platform::rdDrawIndexedGeometry(const platform::IndexedVertexBufferInterface *ivbuffer, const platform::InstanceDataInterface *instanceData, platform::PrimitiveTopology topology, unsigned indexCount, unsigned instanceCount) {
        ...
        void OpenGLES3X11Platform::rdPreframe() {

        }
		        
        void OpenGLES3X11Platform::rdPresent() {
            if(!eglSwapBuffers(_eglDisplay, _eglSurface)) {
                _log.msgError("ES3DesktopX11Platform::rdPresent / opengl %x error\n", eglGetError());
            }
        }

        bool OpenGLES3X11Platform::isInited() const {
            return _eglContext != nullptr;
        }

        void OpenGLES3X11Platform::resetLastVBO() {
            _lastVBO = 0;
            _lastInstanceLayoutDesc = nullptr;
            _lastVertexLayoutDesc = nullptr;
        }

        void OpenGLES3X11Platform::resetLastIBO() {
            _lastIBO = 0;
        }

        void OpenGLES3X11Platform::resetLastProgram() {
            _lastProgram = 0;
        }

        void OpenGLES3X11Platform::resetLastTextures() {
            for (unsigned i = 0; i < unsigned(platform::TextureSlot::_TextureSlotCount); i++) {
                _lastTextures[i] = 0;
            }
        }

        bool OpenGLES3X11Platform::cmpxLastFBO(GLuint fbo) {
            if (_lastFBO != fbo) {
                _lastFBO = fbo;
                return true;
            }
        ...
        bool OpenGLES3X11Platform::cmpxLastDepthCmpFunc(GLuint func) {
        ...
        bool OpenGLES3X11Platform::cmpxLastDepthEnabled(bool enabled) {
        ...
        bool OpenGLES3X11Platform::cmpxLastDepthWriteEnabled(bool enabled) {
        ...
        bool OpenGLES3X11Platform::cmpxLastCullMode(platform::CullMode cullMode) {
        ...
        bool OpenGLES3X11Platform::cmpxLastBlendMode(platform::BlendMode blendMode) {
