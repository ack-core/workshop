...
namespace game {    
    ...
    bool EditorCameraContext::pointerEventHandler(const foundation::PlatformPointerEventArgs &args) {
    ...
    bool EditorCameraContext::keyboardEventHandler(const foundation::PlatformKeyboardEventArgs &args) {
    ...
    void EditorCameraContext::init() {
        _pointerToken = _api.platform->addPointerEventHandler(util::callback(thisweak, &EditorCameraContext::pointerEventHandler));
        _keyboardToken = _api.platform->addKeyboardEventHandler(util::callback(thisweak, &EditorCameraContext::keyboardEventHandler));
