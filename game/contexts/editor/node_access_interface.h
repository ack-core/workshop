...
namespace game {
    ...
    struct EditorNode {
        static std::shared_ptr<EditorNode> (*makeByType[std::size_t(core::WorldInterface::NodeType::_count)])(std::size_t typeIndex);
        
        std::string name;
        std::string resourcePath = EDITOR_EMPTY_RESOURCE_PATH;
        core::WorldInterface::NodeType type;
        ...
        EditorNode(std::size_t typeIndex) : type(core::WorldInterface::NodeType(typeIndex)), globalPosition(0, 0, 0), localPosition(0, 0, 0) {}
        virtual ~EditorNode() {}
    ...
    public:
        ...
        virtual void createNode(core::WorldInterface::NodeType type, const std::string &name, const math::vector3f &position, const std::string &resourcePath) = 0;
