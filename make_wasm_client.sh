EMSDK=/Users/kas/work/2023/emsdk cmake -S . -B ./workshop_wasm -G"Unix Makefiles" -DCMAKE_TOOLCHAIN_FILE="cmake/toolchain_wasm.cmake" -DPLATFORM="PLATFORM_WASM" -DAPPTYPE="IS_CLIENT"
